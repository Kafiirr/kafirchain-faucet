...
export default function Faucet() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://c4.wallpaperflare.com/wallpaper/103/633/205/abstract-beijing-black-and-white-building-wallpaper-preview.jpg')",
        ...
        <form className="mt-4 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className="mt-2 text-center">
              <p className="text-xs text-white mb-1">Have more $KFR? Send back to:</p>
              <p className="text-xs border border-white rounded-md p-2 bg-black/40 text-white inline-block">
